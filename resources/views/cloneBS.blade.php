            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap">
                        ...
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active">Examples</a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    bg-purple" type="button"><small>latest (5.3.x) <i class="bi-check"></i></small>
                                            </button</li>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5"><a href="#">Bootstrap Icons</a> is an open source VG icon library featuring over 1,800 glyphs, with more added every release They're designed to work in any project, whether you use Bootstrap itself or not. Jse them as SVGs or icon fonts--both options give you vector scaling and easy customization via CSS.</p>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from <a href="#">official Bootstrap Themes marketplace</a>. Themes are built on Bootstrap as their own extended frameworks, rich with new components and plugins, documentation, and powerful build tools.</p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">
                    Browse Bootsrtap Themes
                    <i class="bi bi-arrow-right mb-2"></i>
                    </a>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/bs-themes.png') }}" alt="Bootsrtap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="{{ Vite::asset('resources/images/logo-black.svg') }}" alt="Bootsrtap logo" style="width: 40px;">
                            <div class="fs-5 ms-2 text-black">Bootstrap</div>
                        </div>
                    </a>
                    <div class="mt-2 text-muted">
                        <small> Designed and built with all the love in the world by the <a href="#" class="text-black">Bootstrap team</a>with the help of <a href="#" class="text-black">our contribution</a>.</small>
                    </div>
                    <div class="mt-2 text-muted">
                        <small>Code licensed <a href="#" class="text-black">MIT</a>,docs <a href="#" class="text-black"> CC BY 3.0</a></small>
                    </div>
                    <div class="mt-2 text-muted">
                        <small>Currently v5.3.0-apha2.</small>
                    </div>
                </div>
                ...
                <div class="col-6 col-lg-2 mb-5">
                    <h5>Guides</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="#">Getting Strated</a></li>
                        <li class="mb-2"><a href="#">Strater Template</a></li>
                ...
                <div class="col-6 col-lg-2 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">npm strater</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-5">
                    <h5>Community</h5>
